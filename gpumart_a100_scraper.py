#!/usr/bin/env python3
"""
GPU-Mart A100 GPU Pricing Scraper
Extracts A100 pricing from gpu-mart.com - Dynamic pricing only
"""
...
class GPUMartA100Scraper:
    """Scraper for GPU-Mart A100 pricing"""

    def __init__(self):
        self.name = "GPU-Mart"
        self.base_url = "https://gpu-mart.com"
        self.headers = {
    ...
    def get_a100_prices(self) -> Dict[str, str]:
        ...
        patterns = [
            (r'A100.*?Dedicated Server.*?\$([0-9.]+)/hr', 'A100 Dedicated Server (Hourly)'),
...
def main():
    ...
    output_file = 'gpumart_a100_prices.json'
